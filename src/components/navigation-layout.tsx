    ...
    return (
        <div className="fixed inset-0 bg-slate-950 flex flex-col items-center justify-center p-6 overflow-hidden animate-fade-in">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    className={`absolute ${accentColor === "blue" ? "top-[20%] right-[10%]" : "bottom-[10%] left-[10%]"
                        } w-[60%] h-[60%] rounded-full blur-[120px] ${accentColor === "blue"
                            ? "bg-blue-600/10"
                            : accentColor === "purple"
                                ? "bg-purple-600/10"
                                : "bg-green-600/10"
                            ...
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <div className="flex gap-1">
                                    {Array.from({ length: totalSteps }).map((_, i) => (
                                        <div
                                            key={i}
                                            className={`h-1 w-6 rounded-full transition-all duration-500 ${i + 1 <= step
                                                ? accentColor === "blue"
                                                    ? "bg-blue-500"
                                                    : accentColor === "purple"
                                                        ? "bg-purple-500"
