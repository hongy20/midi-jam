...
export function PlayPageView({
  ...
  return (
    <div className="bg-background text-foreground grid h-dvh w-screen grid-rows-[auto_1fr_auto] overflow-hidden">
      <header className="bg-background/80 border-foreground dark:border-ring min-h-[601px]:h-16 flex h-12 w-full items-center justify-between border-b-4 px-6 backdrop-blur-sm">
