...
export default function PlayPage() {
  ...
  return (
    <PageLayout
      ...
      header={
        <div className="h-[var(--header-height)] w-full p-4 sm:p-8 flex justify-between items-center layout-padding bg-background/50 backdrop-blur-md border-b border-foreground/5">
