# CSS-Driven Piano Visibility & Range Calculation Plan
...
#### Range Utility (`src/lib/device/piano.ts`)
...
#### Page-Level Orchestration (`src/app/play/page.tsx`)
The `GamePage` will:
...
### 4. CSS Changes (`src/components/piano-keyboard/piano-grid.module.css`)
