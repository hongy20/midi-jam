...
**Goal:** Ensure carousel navigation buttons are always visible by moving the "safe zone" padding from the Carousel's _internal_ padding to an _external_ wrapper or margin.
