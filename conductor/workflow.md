...
8. **Commit Code Changes:**
   ...
   - **Step 8.4: Request Permission:** Ask the user for permission to perform the commit. Do not proceed without user confirmation.
   - **Step 8.5: Perform the Commit:** Upon receiving permission, perform the commit.
